/*
  ...
  - Made the column `pro_discount` on table `Promotion` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "Promotion" ALTER COLUMN "pro_discount" SET NOT NULL;
